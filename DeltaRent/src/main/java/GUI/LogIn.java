...
public class LogIn extends JPanel {
	...
	public LogIn() {
		...
		/*
		 * ActionListener btnRegistratiAzienda = new ActionListener() { public void
		 * actionPerformed(ActionEvent e) { if(areAllFieldsFilledForAzienda()) {
		 * btnRegistrati_1.setEnabled(true); btnRegistrati.setEnabled(true); } else {
		 * btnRegistrati_1.setEnabled(false); btnRegistrati.setEnabled(false); } } };
		 * textField_1.addActionListener(btnRegistratiAzienda);
		 * emailFieldReg.addActionListener(btnRegistratiAzienda);
		 * textField_3.addActionListener(btnRegistratiAzienda);
		 * passwordFieldReg.addActionListener(btnRegistratiAzienda);
		 */
