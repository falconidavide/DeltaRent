...
public class Utente {
    ...
    public static Utente getUserByEmailAndPassword(String email, String password) {
        try {
            ...
            if (rs.next()) {
                return new Utente(rs.getString("email"), rs.getString("password"),rs.getString("nome"),rs.getString("cognome"),rs.getString("dataDiNascita"),rs.getString("nomeAzienda"),rs.getString("partitaIVA"),rs.getInt("isPrivato"));
            }
