...
public class LogIn extends JPanel {
    ...
    private JPasswordField passwordFieldRegUser;
    ...
    public LogIn() {
        ...
        ActionListener lAzienda = new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                String nomeAzienda = nomeAziendaFieldReg.getText();
                String partitaIva = partitaIvaFieldReg.getText();
        ...
        ActionListener lPrivato = new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                String email = emailFieldRegUser.getText();
                String password = new String(passwordFieldRegUser.getPassword());
                String nome = nomeFieldReg.getText();
                String cognome = cognomeFieldReg.getText();
                String dataNascita = dataNascitaFieldReg.getText();
    ...
    private boolean areAllFieldsFilledForAzienda() {
        return !nomeAziendaFieldReg.getText().trim().isEmpty() && isValidPIVA(partitaIvaFieldReg.getText().trim())
                && isValidEmail(emailFieldReg.getText().trim()) && isValidPassword(new String(passwordFieldReg.getPassword()).trim());
    }
    ...
    private boolean areAllFieldsFilledForPrivato() {
        return !nomeFieldReg.getText().trim().isEmpty() && !cognomeFieldReg.getText().trim().isEmpty()
                ...
                && isValidPassword(new String(passwordFieldRegUser.getPassword()).trim());
    }
